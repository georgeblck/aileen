...
while True:
    ...
    t = time.time()
    syscmd("omxplayer -b --loop --no-osd -o local --vol 10000 " + videos[0])
    ...
    t = time.time()
    syscmd("omxplayer -b --loop --no-osd -o local --vol 10000 " + videos[1])
    ...
    if wasevent == True:
        ...
        syscmd("omxplayer -b --no-osd -o local --vol 10000 " +
